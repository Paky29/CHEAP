...
#Stacking
#LassoRegression, RidgeRegression, ElasticNet, SVR
...
def evaluate(individual, X_train, X_test, y_train, y_test):
    ...
    X_meta = np.column_stack((y_pred_lasso, y_pred_ridge, y_pred_elasticnet,y_pred_svr))

    meta_regressor = LinearRegression()
    meta_regressor.fit(X_meta, y_test)

    # Effettua le previsioni sul set di test del meta-modello
